...
const BatchResponseSchema = `[
  {
    ...
    "explanation_leadership": "<2-3 sentences with a direct quote from the application in double quotes where possible>",
    "explanation_motivation": "<2-3 sentences with a direct quote from the application in double quotes where possible>",
    "explanation_growth": "<2-3 sentences with a direct quote from the application in double quotes where possible>",
    "explanation_vision": "<2-3 sentences with a direct quote from the application in double quotes where possible>",
...
const ResponseSchema = `{
  ...
  "incomplete_flag": <bool>,
  "explanation_leadership": "<2-3 sentences with specific evidence. Include at least one direct quote from the application in double quotes where possible.>",
  "explanation_motivation": "<2-3 sentences with specific evidence. Include at least one direct quote from the application in double quotes where possible.>",
  "explanation_growth": "<2-3 sentences with specific evidence. Include at least one direct quote from the application in double quotes where possible.>",
  "explanation_vision": "<2-3 sentences with specific evidence. Include at least one direct quote from the application in double quotes where possible.>",
